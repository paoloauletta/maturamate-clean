...
var On = I((ct)=>{
    ...
    ct.toByteArray = Po;
    ct.fromByteArray = Lo;
    var ue = [], ee = [], _o = typeof Uint8Array < "u" ? Uint8Array : Array, Ut = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz01\
23456789+/";
...
S"
    ...
    var tr = "([+-]?\\d+)", Oa = tr + "\\s+years?", qa = tr + "\\s+mons?", Qa = tr + "\\s+days?", Na = "\
([+-])?([\\d]*):(\\d\\d):(\\d\\d)\\.?(\\d{1,6})?", ja = new RegExp([
        Oa,
        qa,
        Qa,
        Na
...
`);
    ...
    de.exports.getFileName = function(r) {
        var e = r || m.env, t = e.PGPASSFILE || (_t ? bs.join(e.APPDATA || "./", "\
...
ndSCRAMClientFinalMessage"), wc = a((r)=>k.addCString(r).flush(81), "query"), qs = [], bc = a((r)=>{
        let e = r.name || "";
...
odeOnlyBuffer"), Bc = Rt(72), Lc = Rt(83), Fc = Rt(88), kc = Rt(99), Mc = {
        startup: pc,
        password: yc,
        requestSsl: dc,
...
var fa = Object.defineProperty, ha = Object.defineProperties, pa = Object.getOwnPropertyDescriptors, gi = Object.getOwnPropertySymbols, da = Object.prototype.hasOwnProperty, ya = Object.prototype.propertyIsEnumerable, wi = a((r, e, t)=>e in r ? fa(r, e, {
    ...
    258
]).buffer)[0] === 2, ba = new TextDecoder, Kt = new TextEncoder, dt = Kt.encode("0123456789\
...
a(At, "NeonDbError");
var we = At, rs = "transaction() expects an array of queries, or a function returning a\
n array of queries", Pu = [
    "severity",
    "code",
    "detail",
    "hint",
...
//# sourceMappingURL=node_modules_%40neondatabase_serverless_index_mjs_d945d27e._.js.map